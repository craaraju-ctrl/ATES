...
impl AutonomousBacktester {
    ...
    pub async fn run_backtest(
        ...
        for ctx in data {
            ...
            let adjusted_entry = if direction == TradeDirection::Long { ctx.current_price + slip } else { ctx.current_price - slip };
            ...
            if summary.executed {
                ...
                let exit_price = if direction == TradeDirection::Long { adjusted_entry * 1.02 - exit_slip } else { adjusted_entry * 0.98 + exit_slip };
