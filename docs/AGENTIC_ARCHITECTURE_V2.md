# 🧬 ATES v2 — True Learning Agentic Trading Architecture

> **Goal:** Upgrade ATES from a rule-augmented reactive loop to a genuinely autonomous, self-learning agentic trading system that reflects on mistakes, retrieves similar past experiences, debates decisions internally, and evolves its strategy over time.
...
gantt
    ...
    Multi-Agent Debate          :active, m4, 00:00:15, 10s
