# 🛡️ ATES Disciplined Core Specification

> **The Non-Negotiable Foundation** — Professional trading rules encoded in Rust so agents make consistent, rule-based decisions rather than relying purely on LLM prompting.
